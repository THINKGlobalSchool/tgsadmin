...
if (get_input('entities')) {
	...
	*/
	...
	$options = array(
		...
		'created_time_lower' => '1283299200', // Sept 1, 2010 00:00:00
	...
	echo "<a href='video_export.php?entities=1{$role_param}'>Dump Videos</a><br />";
}